...
-   **Filtration System:** Located on the south wall of RH273, this consists of a vacuum pump, copper manifold, valves with yellow hands, and red tubing. The yellow handles control the openings (**parallel to copper pipe is off, perpendicular to pipe is on**).
    ...
    ![The two valves on the left are open.](SOP-photos/filtration-system.jpg)
...
-   **Filtration apparatus:** including
    ...
    -   (clear) stopper for the spout.
        ...
        ![](SOP-photos/filtration-apparatus.jpg)

    > **`r kableExtra::text_spec("Important:", color = "red")`** the filter disk and funnel cup both have orange/red O-rings on the bottom, if they are missing the apparatus will have an inproper seal and leak.

-   **GF/F ashed-filters (combusted):** these are wrapped in foil and located: <!-- Needs location still -->
...
1.  Agitate the raw sample (**invert 5 times**) with the cap on before pouring. Aim for the center of the funnel.
    ...
    ![](SOP-photos/filtered-sample.jpg){width="378"}
...
2.  Slowly pour until \~**50 ml** of sample has passed through the filter into the catch bottle (see image). **This is the sample rinse.**
    ...
    ![](SOP-photos/rinsing-apparatus.jpg)
...
3.  Pour about **5ml** of the filtered sample into its labeled bottle. You can use the spout or pour from the top.
    ...
    ![](SOP-photos/filtered-sample.jpg){width="387"}
...
1.  If doing SSC analysis rinse the filter to get leftover sediment out of the bottle.
    ...
    ![](SOP-photos/cleaning-isco-bottle.jpg){width="403"}
...
5.  Other method of just holding bottle over filter and using a squeeze bottle to flush the dirt out. <!-- seems like more of a note, was highlighted?? -->

6.  the rinsed filter on the tin foil covered tray. With a marker write the filter number next to it.

7.  Place in drying oven at 105 degrees C for XX hours. <!-- Needs hours -->
...
3.  Using DI water rinse the receiving container **three times.** Be sure to rinse the spouts out.
    ...
    ![](SOP-photos/rinsing-apparatus2.jpg){width="349"}
...
> **`r kableExtra::text_spec("Important:", color = "red")` Frozen sample bottles will expand or break if overfilled!**
...
> **`r kableExtra::text_spec("Important:", color = "red")` Check with project lead before dumping any sample!**

| Analysis | Bottle Type | What to Do when Analysis is `r kableExtra::text_spec("Complete", color = "red")` |
|------------------|------------------|-------------------------------------|
