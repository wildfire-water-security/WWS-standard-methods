...
pt 4 save file, save code do not re-run on second round! print the
blanks off
...
blank_labels 
#print blank labels 
print <- blank_labels %>% select(sample_name,field_sample_ID_blank,study,site,date_text_PST,time_text_PST) #reorder so it's easier for data entry
safe.write_csv(print, blank_fileformat, row.names=FALSE)

stop("Before printing lab labels out- fill out blank columns for date and time and print lab labels (as text only! example: for 2PST write 1400- make sure it's not PDT), save file.")


```

pt 5 before running this part, fill out the time_text column and save
file rerun parts 1-3. IMPORTANT: DO NOT RUN PART 4 again. If you do,
clear the workspace and try again
